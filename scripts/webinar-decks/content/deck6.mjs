  ...
  slides: [
    {
      ...
      items: [
        ...
        { title: "The settings that matter", sub: "Five values in Vercel and what each does." },
    ...
    },
    {
      ...
      notes: "Orient the room left to right: people describe changes, GitHub records them, Vercel rebuilds, the domain serves it. The three feeder boxes below: studio saves commit into GitHub; 123 Reg points the name at Vercel and hosts the mailboxes; the Land Registry feeds market data into the investor portal automatically.",
    },
    {
      type: "panels",
      label: "GitHub",
    ...
    },
    {
      ...
      panels: [
        ...
        },
        {
          ...
          body: ["Vercel also holds the site's private settings — admin accounts, signing secrets, the repository token. Changing one requires a redeploy to take effect."],
        },
        {
    ...
    },
    {
      ...
      panels: [
        ...
        },
        {
          ...
          body: [
            "The @satisgroup.co.uk email addresses are mailboxes managed alongside the domain — including the enquiries inbox the website's email links feed (webinar 07).",
    ...
    },
    {
      ...
      panelH: 2.5,
      notes: "Transparency slide — it prevents wrong assumptions downstream ('check the contact-form inbox' — there isn't one yet). Each gap has a clear, small path to close when the business wants it.",
    },
  ],
  takeaways: [
