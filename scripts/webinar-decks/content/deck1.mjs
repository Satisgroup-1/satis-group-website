...
export const deck = {
  ...
  subtitle: "How anyone on the team changes pages, photos and copy, just by describing the change in plain English.",
  ...
  slides: [
    ...
    },
    {
      ...
      intro: "Claude Code is Claude working directly on the website's repository. You reach it from a web browser; there is nothing to install.",
      ...
      notes: "Reassure the room: a Claude session is a conversation, not a control panel. Nothing they type goes live by itself. There is a deliberate step (commit, then the automatic republish) between conversation and the public site.",
    },
    {
      type: "panels",
      label: "How to ask",
    ...
    },
    {
      ...
      steps: [
        { n: 1, title: "Claude confirms the commit", body: "It tells you what it changed and that the change is pushed. If the team reviews changes first, it opens a pull request instead (a change waiting for approval)." },
    ...
    },
    {
      type: "steps",
      label: "Bigger jobs",
      title: "Adding a whole new development, in one request.",
    ...
    },
    {
      ...
      dark: true,
      notes: "Close the loop on fear. The three safety properties: visibility before commit, audit trail after, rollback always. Invite the room to try one small real request this week, like a typo fix or a status change.",
    },
  ],
  takeaways: [
