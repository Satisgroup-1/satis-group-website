...
export const deck = {
  ...
  name: "Contact & email",
  title: "Contact & email.",
  subtitle: "How enquiries reach the team today — the forms, the email links, the enquiries inbox, and what is changing next.",
  cover: "cover-email.jpg",
  coverNotes:
    "This session is about every route a message can take from the website to the team: the two forms (which now deliver by email), the email links all over the site, the enquiries inbox they all land in, the daily habits, and the newsletter signups that are rolling out.",
  slides: [
    {
      type: "agenda",
    ...
    },
    {
      ...
      notes: "The topics matter for routing once forms are wired: they are the future sorting labels. Today, the email address shown beside the form is the reliable path — next slides.",
    },
    {
      type: "imageFocus",
      label: "The forms",
    ...
    },
    {
      ...
      dark: true,
      subY: 4.35,
      notes: "The operational takeaway: form submissions and email-link messages land in the same inbox, and both are answered the same way — hit Reply. The failure mode is honest by design: no key or a provider outage means the visitor is told to email info@satisgroup.co.uk directly.",
    },
    {
      type: "diagram",
      ...
      notes: "Enquiry mail is delivered into the noreply.ai@satisgroup.co.uk mailbox — make sure everyone knows that is the inbox to watch. Form submissions land in the same place, so there is exactly one inbox to run. (If the team ever wants the visible on-page address changed, it is a one-sentence Claude request.)",
    },
    {
      type: "table",
      label: "The working channel",
      ...
      colW: [3.6, 4.6, 3.9],
      rows: [
        ["Footer — every page", "The contact email address", "—"],
        ["Contact page", "The address beside the form", "—"],
    ...
    },
    {
      ...
      aside: {
        tone: "tip",
        title: "A useful test",
        body: ["Once a month, click the site's own links and email in a test enquiry. If it reaches the inbox and gets answered within a day, the channel works."],
        h: 2.1,
      },
      stepsW: 7.9,
      notes: "Adapt names/rotas to how the team actually assigns ownership. The monthly self-test catches silent failures — a changed mailbox password, a forwarding rule gone stale — before an investor does.",
    },
    {
      type: "steps",
      label: "What's next",
  ...
  takeaways: [
    ...
    "Watch the enquiries mailbox daily; log investment enquiries the same day.",
