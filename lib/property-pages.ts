...
export const PROPERTY_PAGES: PropertyPageData[] = [
  ...
  },
  {
    ...
    intro: {
      heading: "A completed Satis development",
      body: [
        "Southbank is a completed residential development delivered by Satis Group.",
        "Scheme detail and photography for this historical project will be added to this page shortly.",
      ],
      image: "/images/pipeline/southbank.jpg",
      imageAlt: "Southbank residential development",
    },
    stats: [
      { value: "Residential", label: "Use" },
      { value: "Completed", label: "Status" },
